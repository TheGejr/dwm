...
static const char *volmute_media[] = { "amixer", "set", "Master", "toggle", NULL };
static const char *pause_media[]   = { "mpc", "toggle", NULL };
...
static const Key keys[] = {
  ...
  { 0,                            0x1008ff11, spawn,          {.v = voldown_media } },
  { 0,                            0x1008ff12, spawn,          {.v = volmute_media } },
  { 0,                            0x1008ff13, spawn,          {.v = volup_media } },
  { 0,                            0x1008ff14, spawn,          {.v = pause_media } },
